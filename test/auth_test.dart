...
import "package:tuto/services/auth/auth_provider.dart";
...
void main() {
  group("Mock Authentification", () {
    ...
    test("Create user should delegate to login function", () async {
      final badEmailUser =
          provider.createUser(email: "foo@bar.com", password: "123123");
      expect(badEmailUser,
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    ...
    const user =
        AuthUser(id: "mid", email: "foo@bar.com", isEmailVerified: true);
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser =
        AuthUser(id: "myiod", email: "foo@bar.com", isEmailVerified: true);
    _user = newUser;
  }
}
